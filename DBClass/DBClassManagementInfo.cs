...
{
    class DBClassManagementInfo
    {
        public string TableName = "ManagementInfo";
        string errorMsg;
        string ConnString;
        ...
        public bool InsertData(System.Collections.ArrayList ArrField)
        {
            ...
            insertCmd = "Insert Into " + TableName + " (UserId,CNAME,ENAME,Sex,Birthday,BooldType,ID,PresentAddress,Phone,Title";
            ...
            insertCmd = insertCmd + "'" + ArrField[9] + "'";   //職稱
            insertCmd = insertCmd + ")";
        ...
        public bool Update(System.Collections.ArrayList ArrField)
        {
            ...
            updateCmd = updateCmd + " Title='" + ArrField[9] + "'";　　　　　      //職稱
